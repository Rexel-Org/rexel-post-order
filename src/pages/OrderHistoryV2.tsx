...
function OrderCard({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "group relative cursor-pointer overflow-hidden rounded-[var(--border-radius-sm)] border border-[#E0E4EB] bg-white p-[var(--spacing-3)] transition-all duration-150 hover:border-[var(--color-primary)] hover:shadow-[var(--shadow-3)] hover:-translate-y-[1px]",
